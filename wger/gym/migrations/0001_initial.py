    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city',
                 models.CharField(
                     max_length=30, null=True, verbose_name='City',
                     blank=True)),
                ('street',
                 models.CharField(
                     max_length=30,
            ...
            fields=[
                ...
                ('include_inactive',
                 models.BooleanField(
                     default=True,
                     help_text=
                     'Include this user in the email list with inactive members',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document',
                 models.FileField(
                     upload_to=wger.gym.models.gym_document_upload_dir,
                     verbose_name='Document')),
                ('original_name',
                 models.CharField(max_length=128, editable=False)),
                ('name',
                 models.CharField(
                     ...
                     blank=True)),
                ('note',
                 models.TextField(null=True, verbose_name='Note', blank=True)),
                ('member',
                 models.ForeignKey(
