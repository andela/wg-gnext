...
from wger.manager.models import (Workout, Day, Set, Setting)
        ...
        canonical_form = {
            ...
            'set_list': [{
                'exercise_list': [{
                    ...
                    'setting_text':
                    u'2 \xd7 8',
                    'repetition_units': [repetition_unit, repetition_unit],
        ...
        canonical_form = {
            ...
            'set_list': [{
                'exercise_list': [{
                    ...
                    'setting_list': [
                        u'10 (15 kg)', u'10 (15 kg)', u'10 (15 kg)',
                        u'10 (15 kg)'
                    ],
                    ...
                    u'4 \xd7 10 (15 kg)',
                    'repetition_units': [
                        repetition_unit, repetition_unit, repetition_unit,
                        repetition_unit
                    ],
                    'weight_units':
                    [weight_unit, weight_unit, weight_unit, weight_unit]
                }],
                'is_superset':
                False,
                'has_settings':
